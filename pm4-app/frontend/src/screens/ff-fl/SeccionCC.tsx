...
const REQUISITOS = [
  ...
  '¿Tienen implementado un ciclo de auditoría que garantiza que todas las áreas de la compañía son evaluadas en un periodo máximo de un año?',
...
export default function SeccionCC({ form }: { form: Form }) {
    ...
    <div>
      ...
      <div className="form-subsection dyo-subsection">
        ...
        <div className="dyo-propuesta-table">
          ...
          {([
            ['frm_cc_prop_01_limite', 1],
            ['frm_cc_prop_02_limite', 2],
            ['frm_cc_prop_03_limite', 3],
        ...
        <p className="dyo-nota">
          Nota: modalidad Descubrimiento — cubre actos descubiertos durante la vigencia independientemente de cuándo ocurrieron.
        </p>
      </div>
